        ...
        <>
            <div className='profile-container'>
                        ...
                        <div className='icons-social'>
                            <a href="https://www.linkedin.com/in/dannycastilloo/">
                                <button className='button-contact'>
                                    <img src='../src/assets/contact/Linkedin.svg' alt='Linkedin' />
                                </button>
                            </a>
                            <a href="https://github.com/dannycastilloo">
                                <button className='button-contact'>
                                    <img src='../src/assets/contact/Github.svg' alt='Github' />
                                </button>
                            </a>
                            <a href="mailto:dannycastillootiniano@gmail.com">
                                <button className='button-contact'>
                                    <img src='../src/assets/contact/Email.svg' alt='Email' />
                                </button>
                            </a>
                            <a href="https://wa.link/zvm7kf">
                                <button className='button-contact'>
                                    <img src='../src/assets/contact/WhatsApp.svg' alt='WhatsApp' />
                                </button>
                            </a>
                        </div>
                    </div>
                ...
                <div className='my-photo'>
                    <img className='photo' src='../src/assets/danny.png' alt="Danny Castillo" />
                </div>
            </div>
        </>
    )
